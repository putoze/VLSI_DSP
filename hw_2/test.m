...
[out_img_3,H1_up_3,L1_up_3, LL_up_3, LH_up_3, HL_up_3, HH_up_3] = idwt_2d_97(LL_3, LH_3, HL_3, HH_3);
figure('Name', 'octave3_idwt', 'NumberTitle', 'off');
imshow(mat2gray(out_img_3));
title('octave3_idwt');

[out_img_2,H1_up_2,L1_up_1_2, LL_up_1_2, LH_up_1_2, HL_up_1_2, HH_up_1_2] = idwt_2d_97(out_img_3, LH_2, HL_2, HH_2);
figure('Name', 'octave2_idwt', 'NumberTitle', 'off');
imshow(mat2gray(out_img_2));
title('octave2_idwt');

[out_img_1,H1_up_1,L1_up_1, LL_up_1, LH_up_1, HL_up_1, HH_up_1] = idwt_2d_97(out_img_2, LH_1, HL_1, HH_1);
...
function [out_img,H1_up,L1_up, LL_up, LH_up, HL_up, HH_up] = idwt_2d_97(LL, LH, HL, HH)
    ...
    % Define temporary variables
    [row col] = size(LL);
    L1_tmp1 = zeros(row, col*2);
    L1_tmp2 = zeros(row, col*2);
    L1      = zeros(row, col*2);
    H1_tmp1 = zeros(row, col*2);
    H1_tmp2 = zeros(row, col*2);
    H1      = zeros(row, col*2);
